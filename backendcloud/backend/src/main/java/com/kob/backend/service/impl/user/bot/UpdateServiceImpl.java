...
import com.kob.backend.mapper.pojo.Bot;
...
public class UpdateServiceImpl implements UpdateService {
    ...
    public Map<String, String> update(Map<String, String> data) {
        ...
        if (!bot.getUserId().equals(user.getId())) {
            map.put("message", "没有权限更新该Bot");
            return map;
        }

        Bot newBot = new Bot(bot.getId(), bot.getUserId(), title, description, content, bot.getCreatetime(), new Date());
